# Generated static ISO-4217 choices for HBL
CURRENCY_CHOICES = [
    ('AED', 'AED — UAE Dirham'),
    ('AFN', 'AFN — Afghani'),
    ('ALL', 'ALL — Lek'),
...
def currency_symbol(code: str, fallback: str = '') -> str:
    code = (code or '').upper()
    return COMMON_CURRENCY_SYMBOLS.get(code, fallback or code)

# Activos de pago no ISO-4217 usados por HBL. Se mantienen separados de las monedas fiat.
...
PAYMENT_CURRENCY_CHOICES = CURRENCY_CHOICES + CRYPTO_CURRENCY_CHOICES
